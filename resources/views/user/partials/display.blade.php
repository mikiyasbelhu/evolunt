                ...
                <div class="media-body">
                    <h5 class="media-heading">
                        <div class="m-t-md btn-group" style="display: inline">
                            ...
                            >
                                <button class="btn btn-md  btn-azure pull-left"
                                        style='display: inline'><span class="glyphicon glyphicon-envelope"></span>Message
                                </button>
                            </form>

                            @if (!Auth::user()->isFollowing($user))
                                <a href="{{ route('friends.follow', ['username' => $user->username ]) }}"
                                   class="btn btn-md  btn-palegreen pull-left"
                                   style='display: inline'><span class="glyphicon glyphicon-plus-sign"></span>Follow
                                </a>
                            @else
                                ...
                                <form action="{{ route('friends.unfollow', ['username' => $user->username]) }}"
                                    ...
                                    <button type="submit"
                                            class="btn btn-md btn-darkorange pull-left"
